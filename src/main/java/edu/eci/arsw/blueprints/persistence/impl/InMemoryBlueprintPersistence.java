...
public class InMemoryBlueprintPersistence implements BlueprintsPersistence{
    ...
    public void deleteBlueprintByAuthor(String author, String name) throws BlueprintNotFoundException{
